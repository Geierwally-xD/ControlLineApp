...
#define UnderVoltageDelay 3000       /* 3000ms deley for under voltage failure */
...
class VoltageProtection
{
  public:
    ...
    } voltProtTaskState;         /* states of voltage protectio task state machine */
 ...
 ********************************************************************/
  void Control(uint8_t buttonPressState);
    ...
    int voltCell_1_Pin_;         /* attribute for analog pin for voltage imput battery cell 1 */
    int voltCell_2_Pin_;         /* attribute for analog pin for voltage imput battery cell 2 */
